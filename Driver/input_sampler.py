...
num_samples = 10  # need to generate more samples than will be used in the end since for some weights the planner returns the same trajectory
feature_set = []
